...
internal static class Program
{
        ...
        CancellationToken token)
    {
        ...
        var workspaceRoot = string.IsNullOrWhiteSpace(options.RootPath)
            ? null
            : Path.GetFullPath(options.RootPath);
        var rootUri = workspaceRoot is null ? null : new Uri(workspaceRoot);
        var workspaceInit = workspaceRoot is null
            ? null
            : new
            {
        ...
        var initParams = new
        {
            ...
            initializationOptions = workspaceInit is null ? null : new { workspace = workspaceInit }
        };
