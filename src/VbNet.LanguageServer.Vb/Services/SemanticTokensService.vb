...
Namespace Services
    ...
    Public NotInheritable Class SemanticTokensService
        ...
        Private Shared ReadOnly ClassificationMap As Dictionary(Of String, TokenInfo) = New Dictionary(Of String, TokenInfo)(StringComparer.Ordinal) From {
            ...
            {ClassificationTypeNames.Identifier, New TokenInfo("variable")},
            {ClassificationTypeNames.LabelName, New TokenInfo("variable")},
            ...
            {ClassificationTypeNames.PreprocessorKeyword, New TokenInfo("keyword")},
            {ClassificationTypeNames.PreprocessorText, New TokenInfo("comment")},
            {ClassificationTypeNames.Comment, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentComment, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentText, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentDelimiter, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentName, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentAttributeName, New TokenInfo("comment")},
            {ClassificationTypeNames.XmlDocCommentAttributeValue, New TokenInfo("comment")},
            ...
            {ClassificationTypeNames.XmlLiteralText, New TokenInfo("string")},
            {ClassificationTypeNames.XmlLiteralName, New TokenInfo("string")},
            {ClassificationTypeNames.XmlLiteralAttributeName, New TokenInfo("string")},
            {ClassificationTypeNames.XmlLiteralAttributeValue, New TokenInfo("string")},
