...
- 2026-01-18: macOS arm64 netcoredbg builds are blocked by coreclr Darwin support (coreclr repo lacks a supported arm64 branch). Current stopgap is shipping the x64 netcoredbg binary under Rosetta.
